...
void init_lua_constants(Handle<Object> target){
    Local<Object> constants = Nan::New<v8::Object>();
    constants->Set(Nan::New("GLOBALSINDEX").ToLocalChecked(), Nan::New(LUA_GLOBALSINDEX));
    target->Set(Nan::New("LUA").ToLocalChecked(), constants);
}
